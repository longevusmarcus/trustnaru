...
const constructScenePrompts = (careerPath: any, existingImageCount: number = 0): string[] => {
  ...
  if (existingImageCount === 0) {
    return [
      ...
      `HYPERREALISTIC professional photograph of a ${roleTitle} actively working, demonstrating ${keySkills}. Shot on Sony A7R IV, 35mm f/1.8 lens, professional studio lighting setup. CRITICAL: Use EXACT person from reference photo - identical facial features, skin texture, hair, body type, proportions. NO modifications to face or body. Photojournalistic style capturing authentic work moment. Professional environment with depth and detail.`,
  ...
  return [
    // 1) Professional Scene - working as the role
    `HYPERREALISTIC shot of a ${roleTitle} actively working, demonstrating ${keySkills}. Shot on Sony A7R IV, 35mm f/1.8 lens, professional studio lighting setup. CRITICAL: Use EXACT person from reference photo - identical facial features, skin texture, hair, body type, proportions. NO modifications to face or body. Photojournalistic style capturing authentic work moment. Work environment with depth and detail.`,
