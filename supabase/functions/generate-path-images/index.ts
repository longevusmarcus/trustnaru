...
const constructScenePrompts = (careerPath: any, existingImageCount: number = 0): string[] => {
  ...
  return [
    ...
    `HYPERREALISTIC evening candid shot of a ${roleTitle} at a networking event or casual dinner meeting, elegant yet relaxed attire. Shot on Sony A7R IV, 35mm f/1.8 lens, professional studio lighting setup. CRITICAL: EXACT same person from reference - preserve all facial features, expressions, proportions perfectly. NO alterations. Documentary photography style. Different atmosphere and clothing style from previous scenes. Natural social interaction captured authentically.`,
