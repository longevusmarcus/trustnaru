...
const constructScenePrompts = (careerPath: any, existingImageCount: number = 0): string[] => {
  ...
  return [
    ...
    `HYPERREALISTIC evening photograph of a ${roleTitle} at a networking event or casual dinner meeting, elegant yet relaxed attire. Shot on Leica Q3, 28mm f/1.7 lens, ambient warm lighting, artistic bokeh. CRITICAL: IDENTICAL person from reference photo - preserve all facial features, skin, expressions, body, proportions perfectly. NO alterations. No changes whatsoever. No front face but more lateral. Different atmosphere and clothing style from previous scenes. Natural social interaction captured authentically.`,
